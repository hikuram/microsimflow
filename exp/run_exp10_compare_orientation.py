...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Exp10: orientation benchmark using vMF kappa with 3 interface profiles"
    )
    ...
    parser.add_argument("--kappas", nargs="+", type=float, default=[-200, -80, -40, 0, 40, 80, 200])
...
def run():
    ...
    print("Note: this script uses the unified vMF orientation distribution (kappa).")
